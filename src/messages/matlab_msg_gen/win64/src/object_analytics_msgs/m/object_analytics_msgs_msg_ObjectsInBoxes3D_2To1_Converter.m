function ros1msg = object_analytics_msgs_msg_ObjectsInBoxes3D_2To1_Converter(message,ros1msg)
%object_analytics_msgs_msg_ObjectsInBoxes3D_2To1_Converter passes data of ROS 2 message to ROS message.
