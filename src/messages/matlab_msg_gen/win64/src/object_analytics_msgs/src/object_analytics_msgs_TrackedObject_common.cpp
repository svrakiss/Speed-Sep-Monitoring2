...
// Common copy functions for object_analytics_msgs/TrackedObject
#ifdef _MSC_VER
#pragma warning(push)
...
namespace TrackedObject {
  ...
  MDArray_T get_arr_object(MDFactory_T& factory, object_analytics_msgs::msg::TrackedObject::_object_type& val);
  MDArray_T get_arr_roi(MDFactory_T& factory, object_analytics_msgs::msg::TrackedObject::_roi_type& val);
  //----------------------------------------------------------------------------
  void copy_from_arr_object(object_msgs::msg::Object& val, const matlab::data::StructArray& arr) {
    // object.object_name
    try {
  ...
  //----------------------------------------------------------------------------
  OBJECT_ANALYTICS_MSGS_EXPORT void copy_from_arr(std::unique_ptr<object_analytics_msgs::msg::TrackedObject>& msg, const matlab::data::StructArray arr) {
    try {
        //id
  ...
  //----------------------------------------------------------------------------
  OBJECT_ANALYTICS_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const std::shared_ptr<object_analytics_msgs::msg::TrackedObject>& msg) {
    auto outArray = factory.createStructArray({1,1},{"id","object","roi"});
    // id
