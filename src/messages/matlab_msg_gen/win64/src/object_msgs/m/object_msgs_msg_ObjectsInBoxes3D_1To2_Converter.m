function ros2msg = object_msgs_msg_ObjectsInBoxes3D_1To2_Converter(message,ros2msg)
%object_msgs_msg_ObjectsInBoxes3D_1To2_Converter passes data of ROS message to ROS 2 message.
