function ros1msg = object_msgs_msg_ObjectInBox_2To1_Converter(message,ros1msg)
%object_msgs_msg_ObjectInBox_2To1_Converter passes data of ROS 2 message to ROS message.
