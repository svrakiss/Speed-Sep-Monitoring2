function ros1msg = object_msgs_msg_VehicleAttribs_2To1_Converter(message,ros1msg)
%object_msgs_msg_VehicleAttribs_2To1_Converter passes data of ROS 2 message to ROS message.
% Copyright 2019 The MathWorks, Inc.    
ros1msg.Type = message.type{1};
ros1msg.Color = message.color{1};
