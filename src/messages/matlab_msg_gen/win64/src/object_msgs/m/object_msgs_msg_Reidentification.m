function [data, info] = object_msgs_msg_Reidentification
%object_msgs_msg_Reidentification gives an empty data for object_msgs/Reidentification
...
info.MessageType = 'object_msgs/Reidentification';
info.MatPath = cell(1,7);
info.MatPath{1} = 'identity';
info.identity.MLdataType = 'string';
info.identity.constant = 0;
info.identity.default = 0;
info.identity.maxstrlen = NaN;
info.identity.MaxLen = 1;
info.identity.MinLen = 1;
info.MatPath{2} = 'roi';
info.roi = struct();
