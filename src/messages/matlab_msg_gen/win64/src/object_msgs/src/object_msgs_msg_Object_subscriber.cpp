...
// Subscriber for object_msgs/Object
#ifdef _MSC_VER
#pragma warning(push)
...
namespace Object {
  MDArray_T get_arr(MDFactory_T& factory, const std::shared_ptr<object_msgs::msg::Object>& msg);
} //namespace Object
} //namespace matlabhelper
} //namespace object_msgs
class OBJECT_MSGS_EXPORT object_msgs_msg_Object_subscriber : public MATLABSubscriberInterface {
    rclcpp::Subscription<object_msgs::msg::Object>::SharedPtr mSub;
  public:
    object_msgs_msg_Object_subscriber()
        : MATLABSubscriberInterface() {
    }
    virtual ~object_msgs_msg_Object_subscriber() {
    }
    virtual intptr_t createSubscription(const std::string& topic_name,
        ...
        auto callback = [this, sd, sendDataToMATLABFunc, incPubGid](
                            const object_msgs::msg::Object::SharedPtr msg,
                            const rmw_message_info_t& msgInfo) -> void {
            auto outArray = object_msgs::matlabhelper::Object::get_arr(mFactory, msg);
        ...
        mSub = theNode->create_subscription<object_msgs::msg::Object>(topic_name, qos, callback);
        return true;
    }
};
...
CLASS_LOADER_REGISTER_CLASS(object_msgs_msg_Object_subscriber, MATLABSubscriberInterface)
#ifdef _MSC_VER
#pragma warning(pop)
#else
