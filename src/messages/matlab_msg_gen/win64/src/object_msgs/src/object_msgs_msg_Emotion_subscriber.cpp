...
// Subscriber for object_msgs/Emotion
#ifdef _MSC_VER
#pragma warning(push)
...
namespace Emotion {
  MDArray_T get_arr(MDFactory_T& factory, const std::shared_ptr<object_msgs::msg::Emotion>& msg);
} //namespace Emotion
} //namespace matlabhelper
} //namespace object_msgs
class OBJECT_MSGS_EXPORT object_msgs_msg_Emotion_subscriber : public MATLABSubscriberInterface {
    rclcpp::Subscription<object_msgs::msg::Emotion>::SharedPtr mSub;
  public:
    object_msgs_msg_Emotion_subscriber()
        : MATLABSubscriberInterface() {
    }
    virtual ~object_msgs_msg_Emotion_subscriber() {
    }
    virtual intptr_t createSubscription(const std::string& topic_name,
        ...
        auto callback = [this, sd, sendDataToMATLABFunc, incPubGid](
                            const object_msgs::msg::Emotion::SharedPtr msg,
                            const rmw_message_info_t& msgInfo) -> void {
            auto outArray = object_msgs::matlabhelper::Emotion::get_arr(mFactory, msg);
        ...
        mSub = theNode->create_subscription<object_msgs::msg::Emotion>(topic_name, qos, callback);
        return true;
    }
};
...
CLASS_LOADER_REGISTER_CLASS(object_msgs_msg_Emotion_subscriber, MATLABSubscriberInterface)
#ifdef _MSC_VER
#pragma warning(pop)
#else
