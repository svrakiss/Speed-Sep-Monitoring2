...
// Common copy functions for object_msgs/ObjectInBox3D
#ifdef _MSC_VER
#pragma warning(push)
...
namespace ObjectInBox3D {
  ...
  MDArray_T get_arr_object(MDFactory_T& factory, object_msgs::msg::ObjectInBox3D::_object_type& val);
  MDArray_T get_arr_roi(MDFactory_T& factory, object_msgs::msg::ObjectInBox3D::_roi_type& val);
  MDArray_T get_arr_min(MDFactory_T& factory, object_msgs::msg::ObjectInBox3D::_min_type& val);
  MDArray_T get_arr_max(MDFactory_T& factory, object_msgs::msg::ObjectInBox3D::_max_type& val);
  //----------------------------------------------------------------------------
  void copy_from_arr_object(object_msgs::msg::Object& val, const matlab::data::StructArray& arr) {
    // object.object_name
    try {
  ...
  //----------------------------------------------------------------------------
  OBJECT_MSGS_EXPORT void copy_from_arr(std::unique_ptr<object_msgs::msg::ObjectInBox3D>& msg, const matlab::data::StructArray arr) {
    try {
        //object
  ...
  //----------------------------------------------------------------------------
  OBJECT_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const std::shared_ptr<object_msgs::msg::ObjectInBox3D>& msg) {
