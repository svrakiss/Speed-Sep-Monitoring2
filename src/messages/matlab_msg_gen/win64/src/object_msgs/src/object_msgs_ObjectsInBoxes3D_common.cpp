...
// Common copy functions for object_msgs/ObjectsInBoxes3D
#ifdef _MSC_VER
#pragma warning(push)
...
#include "object_msgs/msg/objects_in_boxes3_d.hpp"
...
namespace ObjectsInBoxes3D {
  ...
  void copy_from_arr_objects_in_boxes(object_msgs::msg::ObjectInBox3D& val, const matlab::data::Struct& arr);
  ...
  MDArray_T get_arr_header(MDFactory_T& factory, object_msgs::msg::ObjectsInBoxes3D::_header_type& val);
  MDArray_T get_arr_header_stamp(MDFactory_T& factory, std_msgs::msg::Header::_stamp_type& val);
  MDArray_T get_arr_objects_in_boxes(MDFactory_T& factory, object_msgs::msg::ObjectsInBoxes3D::_objects_in_boxes_type& val);
  MDArray_T get_arr_objects_in_boxes_object(MDFactory_T& factory, object_msgs::msg::ObjectInBox3D::_object_type& val);
  MDArray_T get_arr_objects_in_boxes_roi(MDFactory_T& factory, object_msgs::msg::ObjectInBox3D::_roi_type& val);
  MDArray_T get_arr_objects_in_boxes_min(MDFactory_T& factory, object_msgs::msg::ObjectInBox3D::_min_type& val);
  MDArray_T get_arr_objects_in_boxes_max(MDFactory_T& factory, object_msgs::msg::ObjectInBox3D::_max_type& val);
  //----------------------------------------------------------------------------
  void copy_from_arr_header(std_msgs::msg::Header& val, const matlab::data::StructArray& arr) {
    // header.stamp
    try {
  ...
  //----------------------------------------------------------------------------
  OBJECT_MSGS_EXPORT void copy_from_arr(std::unique_ptr<object_msgs::msg::ObjectsInBoxes3D>& msg, const matlab::data::StructArray arr) {
    try {
        //header
    ...
    try {
        ...
        for (auto _objects_in_boxesarr : objects_in_boxes_arr) {
        	object_msgs::msg::ObjectInBox3D _val;
  ...
  //----------------------------------------------------------------------------
  OBJECT_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const std::shared_ptr<object_msgs::msg::ObjectsInBoxes3D>& msg) {
