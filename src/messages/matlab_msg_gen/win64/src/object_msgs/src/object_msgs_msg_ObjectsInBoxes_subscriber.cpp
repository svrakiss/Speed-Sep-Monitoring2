...
// Subscriber for object_msgs/ObjectsInBoxes
#ifdef _MSC_VER
#pragma warning(push)
...
namespace ObjectsInBoxes {
  MDArray_T get_arr(MDFactory_T& factory, const std::shared_ptr<object_msgs::msg::ObjectsInBoxes>& msg);
} //namespace ObjectsInBoxes
} //namespace matlabhelper
} //namespace object_msgs
class OBJECT_MSGS_EXPORT object_msgs_msg_ObjectsInBoxes_subscriber : public MATLABSubscriberInterface {
    rclcpp::Subscription<object_msgs::msg::ObjectsInBoxes>::SharedPtr mSub;
  public:
    object_msgs_msg_ObjectsInBoxes_subscriber()
        : MATLABSubscriberInterface() {
    }
    virtual ~object_msgs_msg_ObjectsInBoxes_subscriber() {
    }
    virtual intptr_t createSubscription(const std::string& topic_name,
        ...
        auto callback = [this, sd, sendDataToMATLABFunc, incPubGid](
            ...
            auto outArray = object_msgs::matlabhelper::ObjectsInBoxes::get_arr(mFactory, msg);
        ...
        mSub = theNode->create_subscription<object_msgs::msg::ObjectsInBoxes>(topic_name, qos, callback);
        return true;
    }
};
...
CLASS_LOADER_REGISTER_CLASS(object_msgs_msg_ObjectsInBoxes_subscriber, MATLABSubscriberInterface)
#ifdef _MSC_VER
#pragma warning(pop)
#else
