...
object_msgs__msg__ObjectInBox3D__init(object_msgs__msg__ObjectInBox3D * msg)
{
  ...
  if (!object_msgs__msg__Object__init(&msg->object)) {
    object_msgs__msg__ObjectInBox3D__destroy(msg);
    return false;
  }
  // roi
...
{
  object_msgs__msg__ObjectInBox3D * msg = (object_msgs__msg__ObjectInBox3D *)malloc(sizeof(object_msgs__msg__ObjectInBox3D));
  if (!msg) {
    return NULL;
  }
...
object_msgs__msg__ObjectInBox3D__Sequence__init(object_msgs__msg__ObjectInBox3D__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (object_msgs__msg__ObjectInBox3D *)calloc(size, sizeof(object_msgs__msg__ObjectInBox3D));
    if (!data) {
      return false;
    }
...
{
  object_msgs__msg__ObjectInBox3D__Sequence * array = (object_msgs__msg__ObjectInBox3D__Sequence *)malloc(sizeof(object_msgs__msg__ObjectInBox3D__Sequence));
  if (!array) {
    return NULL;
  }
