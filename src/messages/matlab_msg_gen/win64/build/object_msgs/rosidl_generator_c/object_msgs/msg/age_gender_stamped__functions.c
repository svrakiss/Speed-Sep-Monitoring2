...
#include "object_msgs/msg/age_gender_stamped__functions.h"
...
object_msgs__msg__AgeGenderStamped__init(object_msgs__msg__AgeGenderStamped * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    object_msgs__msg__AgeGenderStamped__destroy(msg);
    return false;
  }
  // objects
...
{
  object_msgs__msg__AgeGenderStamped * msg = (object_msgs__msg__AgeGenderStamped *)malloc(sizeof(object_msgs__msg__AgeGenderStamped));
  if (!msg) {
    return NULL;
  }
...
object_msgs__msg__AgeGenderStamped__Sequence__init(object_msgs__msg__AgeGenderStamped__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (object_msgs__msg__AgeGenderStamped *)calloc(size, sizeof(object_msgs__msg__AgeGenderStamped));
    if (!data) {
      return false;
    }
...
{
  object_msgs__msg__AgeGenderStamped__Sequence * array = (object_msgs__msg__AgeGenderStamped__Sequence *)malloc(sizeof(object_msgs__msg__AgeGenderStamped__Sequence));
  if (!array) {
    return NULL;
  }
