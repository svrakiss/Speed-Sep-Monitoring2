...
#ifndef OBJECT_MSGS__MSG__AGE_GENDER__STRUCT_H_
#define OBJECT_MSGS__MSG__AGE_GENDER__STRUCT_H_
...
{
  float age;
  rosidl_generator_c__String gender;
...
#endif  // OBJECT_MSGS__MSG__AGE_GENDER__STRUCT_H_
