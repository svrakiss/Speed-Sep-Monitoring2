...
#ifndef OBJECT_MSGS__MSG__PERSON_ATTRIBUTE_STAMPED__STRUCT_HPP_
#define OBJECT_MSGS__MSG__PERSON_ATTRIBUTE_STAMPED__STRUCT_HPP_
...
struct PersonAttributeStamped_
{
  ...
  explicit PersonAttributeStamped_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init)
  {
    (void)_init;
  }

  explicit PersonAttributeStamped_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init)
  {
    (void)_init;
  }
  ...
  using _attributes_type =
    std::vector<object_msgs::msg::PersonAttribute_<ContainerAllocator>, typename ContainerAllocator::template rebind<object_msgs::msg::PersonAttribute_<ContainerAllocator>>::other>;
  ...
  Type & set__attributes(
    const std::vector<object_msgs::msg::PersonAttribute_<ContainerAllocator>, typename ContainerAllocator::template rebind<object_msgs::msg::PersonAttribute_<ContainerAllocator>>::other> & _arg)
  {
...
#endif  // OBJECT_MSGS__MSG__PERSON_ATTRIBUTE_STAMPED__STRUCT_HPP_
