...
#ifndef OBJECT_MSGS__MSG__OBJECTS_IN_BOXES__STRUCT_HPP_
#define OBJECT_MSGS__MSG__OBJECTS_IN_BOXES__STRUCT_HPP_
...
struct ObjectsInBoxes_
{
  ...
  explicit ObjectsInBoxes_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init),
    image(_init)
  {
  ...
  explicit ObjectsInBoxes_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init),
    image(_alloc, _init)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
...
#endif  // OBJECT_MSGS__MSG__OBJECTS_IN_BOXES__STRUCT_HPP_
