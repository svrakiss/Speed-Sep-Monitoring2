...
#ifndef OBJECT_MSGS__MSG__EMOTION__STRUCT_HPP_
#define OBJECT_MSGS__MSG__EMOTION__STRUCT_HPP_
...
struct Emotion_
{
  ...
  explicit Emotion_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : roi(_init)
  {
  ...
  explicit Emotion_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : emotion(_alloc),
    roi(_alloc, _init)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
...
#endif  // OBJECT_MSGS__MSG__EMOTION__STRUCT_HPP_
