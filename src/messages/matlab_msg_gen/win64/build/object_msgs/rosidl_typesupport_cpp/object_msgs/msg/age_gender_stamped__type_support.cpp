...
static const _AgeGenderStamped_type_support_symbol_names_t _AgeGenderStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, object_msgs, msg, AgeGenderStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, object_msgs, msg, AgeGenderStamped)),
  }
};
...
{
  return &::object_msgs::msg::rosidl_typesupport_cpp::AgeGenderStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, object_msgs, msg, AgeGenderStamped)() {
  return get_message_type_support_handle<object_msgs::msg::AgeGenderStamped>();
}
