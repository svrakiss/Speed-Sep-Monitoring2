...
#include "object_msgs/msg/vehicle_attribs__rosidl_typesupport_fastrtps_cpp.hpp"
...
static size_t _VehicleAttribs__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_VehicleAttribs(full_bounded, 0);
}
