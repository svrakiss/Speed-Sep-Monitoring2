...
#include "object_msgs/msg/age_gender_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
...
static bool _AgeGenderStamped__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  auto typed_message =
    static_cast<const object_msgs::msg::AgeGenderStamped *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}

static bool _AgeGenderStamped__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  auto typed_message =
    static_cast<object_msgs::msg::AgeGenderStamped *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _AgeGenderStamped__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const object_msgs::msg::AgeGenderStamped *>(
...
static size_t _AgeGenderStamped__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_AgeGenderStamped(full_bounded, 0);
}

static message_type_support_callbacks_t _AgeGenderStamped__callbacks = {
  "object_msgs::msg",
  "AgeGenderStamped",
  _AgeGenderStamped__cdr_serialize,
  _AgeGenderStamped__cdr_deserialize,
  _AgeGenderStamped__get_serialized_size,
  _AgeGenderStamped__max_serialized_size
};

static rosidl_message_type_support_t _AgeGenderStamped__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_AgeGenderStamped__callbacks,
...
{
  return &object_msgs::msg::typesupport_fastrtps_cpp::_AgeGenderStamped__handle;
}
